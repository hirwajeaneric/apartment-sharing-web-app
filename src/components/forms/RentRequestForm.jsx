...
export default function RentRequestForm() {
  ...
  return (
    <FormContainer onSubmit={submitRequest} style={{ flexDirection:'column', marginTop: '20px' }}>
      ...
      <TextField type='number' variant='outlined' style={{ width: '100%' }} label='National Id' id='nationalId' size='small' value={formData.nationalId} name='nationalId' onChange={handleFormInputs}/>
      <TextField variant='outlined' style={{ width: '100%' }} label='Passport Number' id='passportNumber' size='small' value={formData.passportNumber} name='passportNumber' onChange={handleFormInputs}/>
